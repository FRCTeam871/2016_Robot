...
public class Lifter {
    ...
    public Lifter(CANTalon telescopingMotor, DoubleSolenoid raisor, DigitalInput grabSense, DigitalInput armUpSense,
            DoubleSolenoid lockSolenoid, Potentiometer telescopePotentiometer, SpeedController pullUpMotor,
            XBoxController xbox, SpeedController beaterBarPos) {
    ...
    public enum LifterStates {
        TRANSPORT, DEPLOY_ARM, EXTEND, PULL_UP, LOCKED, STARTUP_RESET;
    }
